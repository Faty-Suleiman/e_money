...
const validatePhone = (phone) => {
    ...
    if(firstCh === '+' && userPhone.length === 14){return userPhone}
    else if(firstCh === '0' && userPhone.length === 11){return `+234${userPhone.slice(1)}`}
    else if(firstCh === '2' && userPhone === 14 ){`+${userPhone}`}
    else {return false}
}
